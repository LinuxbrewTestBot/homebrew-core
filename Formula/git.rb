class Git < Formula
  ...
  if OS.mac?
    ...
    option "without-openssl", "Build without Homebrew's OpenSSL instead of using CommonCrypto"
    option "without-curl", "Do not use Homebrew's version of cURL library"
  end
